...
function ActionCard({children,icon,onClick,className,indicatorIcon,border}) {
    return (
        <div className={`flex justify-between px-5 py-4 ${border? border : "border border-neutral-content-light rounded-md"}  cursor-pointer w-full ${className} hover:bg-neutral-content-hover`}>
