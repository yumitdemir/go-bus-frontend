        ...
        <div className={`${className}`}>
            <div className={"relative w-full "}>
                ...
                <input type="text" name={"from"} {...register('from', {required: true})}
                       className={"bg-white w-full border text-[#333333] border-e-0 border-[#8b8b8b] rounded-md rounded-r-none ps-10   py-2 text-lg hover:bg-[#f0f0f0] focus:bg-[#f0f0f0] outline-[#153b82] "}/>
            </div>
            <div className={"relative w-full"}>
                <label htmlFor={"label"}
                ...
                <input type="text" {...register('to', {required: true})}
                       className={"bg-white w-full border text-[#333333] border-[#8b8b8b] rounded-md rounded-l-none ps-11  py-2 text-lg hover:bg-[#f0f0f0] focus:bg-[#f0f0f0] outline-[#153b82]"}/>
            </div>
